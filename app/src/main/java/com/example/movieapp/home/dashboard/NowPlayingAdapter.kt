...
class NowPlayingAdapter(private var data: List<FilmModel>,
                        private val listener : (FilmModel) -> Unit)
    : RecyclerView.Adapter<NowPlayingAdapter.NewPlayingViewHolder>() {

    lateinit var contextAdapter : Context

    override fun onCreateViewHolder(parent: ViewGroup,viewType: Int): NowPlayingAdapter.NewPlayingViewHolder {
    ...
    override fun onBindViewHolder(holder: NowPlayingAdapter.NewPlayingViewHolder, position: Int) {
